...
public class AssociationTouches {
    ...
    private static final AssociationTouches[] TOUCHES_PERTINENTES_SPECIALES = { new AssociationTouches(CODE_HAUT),
            new AssociationTouches(CODE_BAS), new AssociationTouches(CODE_DROITE), new AssociationTouches(CODE_GAUCHE),
            new AssociationTouches(CODE_ECHAP), new AssociationTouches(CODE_ENTREE) };
    ...
    public boolean isCaractere(char c) {
        return (this.cle == AssociationTouches.keycodeOf(Character.toLowerCase(c))
                || this.cle == AssociationTouches.keycodeOf(Character.toUpperCase(c)));
    }
