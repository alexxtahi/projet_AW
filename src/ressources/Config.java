...
public class Config {
	...
	/**
	 * La liste des caracteres pertinents; rajoutez ici des caracteres si vous
	 * voulez qu'ils soient detectes Vous pouvez ensuite detecter l'appuie sur votre
	 * nouvelle touche avec la methode AssociationTouches.isCaractere
	 */
	public static final char[] TOUCHES_PERTINENTES_CARACTERES = { 't', 'g' };
	...
	public static void setDimension(int nbCasesX, int nbCasesY) {
		...
		nbPixelsY = (longueurCarteYCases * PIXELS_PAR_CASE) + 2 * PIXELS_MARGE + PIXELS_HAUTEUR_ZONE_TEXTE
