...
public class Affichage {
    ...
    /**
     * Donne l'abscisse correspondant a <code>x</code> dans le referentiel du
     * rectangle: par exemple, <code>x=O.0</code> -> gauche du rectangle,
     * <code>x = 1.0</code> -> droite du rectangle.
     * 
    ...
    /**
     * Donne l'ordonnee correspondant a <code>y</code> dans le referentiel du
     * rectangle: par exemple, <code>y=0.0</code> -> bas du rectangle,
     * <code>y = 1.0</code> -> haut du rectangle.
     * 
     * @param gauche Abscisse gauche du rectangle
     * @param droite Abscisse droite du rectangle
     * @param haut   Ordonnee superieure du rectangle
     * @param bas    Ordonnee inferieure du rectangle
     * @param x
     * @return L'ordonnee correspondant a <code>y</code> dans le referentiel du
     *         rectangle
     */
    ...
    /**
     * Donne l'abscisse correspondant a <code>x</code> dans le referentiel de la
     * carte: par exemple, <code>x=O.0</code> -> gauche de la carte,
     * <code>x = 1.0</code> -> droite de la carte.
     * 
     * @param x
     * @return L'abscisse correspondant a <code>x</code> dans le referentiel de la
     *         carte
     */
    private static double positionInterneCarteX(double x) {
        return (positionInterneRectangleX(Config.limiteGaucheCarte, Config.limiteDroiteCarte, Config.limiteHautCarte,
                Config.limiteBasCarte, x));
    }

    /**
     * Donne l'ordonnee correspondant a <code>y</code> dans le referentiel de la
     * carte: : par exemple, <code>y=O.0</code> -> bas de la carte,
     * <code>y = 1.0</code> -> haut de la carte.
     * 
     * @param y
     * @return L'ordonnee correspondant a <code>y</code> dans le referentiel du
     *         rectangle
    ...
    private static double positionInterneCarteY(double y) {
        return (positionInterneRectangleY(Config.limiteGaucheCarte, Config.limiteDroiteCarte, Config.limiteHautCarte,
                Config.limiteBasCarte, y));
    }

    /**
     * Donne l'abscisse du centre d'une case situee sur la colonne <code>x</code>
     * 
     * @param x Indice d'une colonne, entre <code>0</code> et
     *          <code>Config.mapXLengthSquares-1</code>
     ...
     * 
     * @param y Indice d'une ligne entre <code>0</code> et
     *          <code>Config.mapYLengthSquares</code>
    ...
    /**
     * Donne l'abscisse qui, dans le referentiel de la zone de texte, correspond a
     * <code>x</code>: <code>x=0.0</code> -> gauche de la zone, <code>x = 1.0</code>
     * -> droite de la zone.
     * 
     * @param x proportion en abscisse
     * @return L'abscisse du point qui est a <code>x</code> dans le referentiel de
     *         la zone de texte
     */
    ...
    /**
     * Donne l'ordonnee qui, dans le referentiel de la zone de texte, correspond a
     * <code>y</code>: <code>y=0.0</code> -> bas de la zone, <code>y = 1.0</code> ->
     * haut de la zone.
     * 
     * @param y proportion en ordonnee
     * @return L'abscisse du point qui est a <code>y</code> dans le referentiel de
     *         la zone de texte
     */
    ...
    public static void dessineRectanglePlein(double gauche, double droite, double haut, double bas, Color couleur) {
        ...
        StdDraw.filledRectangle((gauche + droite) / 2.0, (haut + bas) / 2.0, (droite - gauche) / 2.0,
                (haut - bas) / 2.0);
    }
     ...
     * @param texte    La chaine de caractere a afficher, ne doit pas etre trop long
     *                 sinon elle depassera
     * @param couleur  La couleur du texte
     * @param xInterne L'abscisse du debut du texte dans le referentiel de la case;
     *                 <code>0.0</code> -> gauche de la case, <code>1.0</code> ->
     *                 droite de la case
     * @param yInterne L'ordonnee du debut du texte dans le referentiel de la case;
     *                 <code>0.0</code> -> bas de la case, <code>1.0</code> -> haut
     *                 de la case
     * @param f        Police de l'affichage
     */
    public static void afficheTexteDansCase(int xCase, int yCase, String texte, Color couleur, double xInterne,
            double yInterne, Font f) {
        StdDraw.setPenColor(couleur);
        StdDraw.setFont(f);
        StdDraw.text(coordXCentreCase(xCase) + (xInterne - 0.5) * Config.largeurCaseX,
                coordYCentreCase(yCase) + (yInterne - 0.5) * Config.largeurCaseY, texte);
    }
    ...
    public static void dessineImageDansCase(int x, int y, String cheminImage) {
        StdDraw.picture(coordXCentreCase(x), coordYCentreCase(y), cheminImage, Config.largeurCaseX,
                Config.largeurCaseY);
    }
    ...
    public static void dessineCurseur(int x, int y) {
        ...
        double decalageX = Config.largeurCaseX / 2.0 - margeX; // distance entre l'abscisse du centre de la case et le
                                                               // trait du curseur qui en est le plus loin
    ...
    public static void videCase(int x, int y) {
        ...
        StdDraw.filledRectangle(coordXCentreCase(x), coordYCentreCase(y), 0.95 * Config.demiLargeurCaseX,
    ...
    public static void videZoneTexte() {
        dessineRectanglePlein(Config.limiteGaucheTexte, Config.limiteDroiteTexte, Config.limiteHautTexte,
                Config.limiteBasTexte, Config.COULEUR_ARRIERE_PLAN);
    }
    ...
    public static void dessineGrille() {
        for (int i = 0; i <= Config.longueurCarteXCases; i++) {
            dessineLigne(positionInterneCarteX((double) i / (double) Config.longueurCarteXCases),
                    positionInterneCarteY(0), positionInterneCarteX((double) i / (double) Config.longueurCarteXCases),
                    positionInterneCarteY(1), Color.black);
        }
        for (int i = 0; i <= Config.longueurCarteYCases; i++) {
            dessineLigne(positionInterneCarteX(0),
                    positionInterneCarteY(((double) i) / (double) Config.longueurCarteYCases), positionInterneCarteX(1),
                    positionInterneCarteY(((double) i) / (double) Config.longueurCarteYCases), Color.black);
        }
    }
     ...
     * @param echapAutorise     <code>true</code> si le popup peut etre ferme en
     *                          appuyant sur echap (la fonction renvoie alors
     *                          <code>-1</code>)
    ...
    public static int popup(String messageExplicatif, String[] options, boolean echapAutorise, int curseurDefaut) {
        ...
        double left = positionInterneCarteX(0.5) - Config.taillePopupX / 2.0; // abscisse de la gauche de la fenetre de
                                                                              // popup
        double right = positionInterneCarteX(0.5) + Config.taillePopupX / 2.; // abscisse de la droite de la fenetre de
                                                                              // popup
        ...
        do {
            ...
            pixelsCursor = Math.min(0.1 * (right - left) / Config.largeurCaseX, shareForOption / Config.largeurCaseY); // pour
                                                                                                                       // s'assurer
                                                                                                                       // que
                                                                                                                       // l'image
                                                                                                                       // n'est
            ...
            if (key.isHaut()) {
                if (popupCursor == 1 && offsetOptions > 0) {
                    ...
                    dessineRectanglePlein(centerX - widthX / 2.0, centerX + widthX / 2.0, centerY + widthY / 2.0,
